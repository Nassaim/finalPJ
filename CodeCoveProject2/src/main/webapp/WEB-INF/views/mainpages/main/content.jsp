...
<section class="container">
	<div class="p-4 shadow-lg mb-5">
		...
		<div class="h3 fw-bold">CodeCove는 현재</div>
		<!--Countup-->
		<h2 data-countup='{"startVal": 0}' data-to="${pjVO.totalPj +100}" data-aos
			data-aos-once="false" data-aos-id="countup:in"
			class="display-1 fw-bold text-center"
			style="font-size: 6.5rem; color: #00c7ae;">0</h2>
		<!--Text-->
		<div class="h3 fw-bold text-end">개의 Projects와 함께합니다.</div>
	</div>
</section>
							...
							<div class="row mt-3">
								<div class="button_container d-flex">
									<a href="/coco/cooBoard/read?cooNm=${coboList.cooNm}" class="btn">
										<button id="btn" style="border: none; background-color: transparent;"><span style="border: none; background-color: transparent;">협업게시판 바로가기</span></button>
									</a>
								</div>
							</div>
						</div>
